...
Automation`}
                        ...
                        <div className='text-3xl hidden md:hidden lg:hidden xl:block tracking-wider leading-[0.9] bebas-neue1 2xl:text-4xl' >
                            SAS AUTOMATION PVT. LTD.
                        </div>
                    </div>
                </div>
                <div className=" xl:w-1/3 josefin-sans px-10 hidden sm:flex ">
