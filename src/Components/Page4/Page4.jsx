...
function Page2() {
  ...
  return (
    <div ref={block} className='flex-1 h-full pt-0 lg:px-10 border-none bg-gray-900 overflow-hidden lg:pb-10 -z-0'>
      <div
        className="hidden lg:flex h-full bg-center bg-green-500 bg-cover relative justify-end items-center overflow-x-hidden rounded-md overflow-hidden"
      ...
      >
        ...
        className="lg:hidden flex h-full bg-center bg-green-500 bg-cover relative justify-end items-center overflow-x-hidden  overflow-hidden"
        style={{ backgroundImage: `url('/Render06.jpg')` }}
      >
        <div className='h-full w-full bg-black bg-opacity-20 flex items-end pb-8'>
          <p
            ref={(el) => (tagsRef.current[0] = el)}
            className="text-white text-sm sm:text-2xl mt-4 mx-auto text-center px-4 md:pb-14 lg:pb-10 lg:px-8 max-w-4xl josefin-sans"
          >
            <span className='font-bold'>Custom-designed Virtual Environments</span>, Crafted specifically for our motion simulators, delivering ultra-realistic terrain interaction and immersive driving experiences across diverse landscapes.
          </p>
        </div>
